# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2018-02-21 08:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organization.City', verbose_name='所在区域')),
            ],
            options={
                'verbose_name': '课程机构',
